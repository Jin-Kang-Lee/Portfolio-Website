  ...
  return (
    <div id='experience' className='w-full lg:h-screen p-2 py-24'>
        <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
            <p className='text-xl tracking-widest uppercase text-[#504be7] dark:text-[#FF2E63]'>Experience</p>
            <h2 className='py-4'>Where have I been</h2>
            <div className=' gap-8 '>
                <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300 bg-slate-200'>
                    <div className='gap-4 justify-center items-center'>
                        <div className='m-auto'>
                            ...
                            height={64} 
                            alt='/'/>
                            <p className='text-black'>PricewaterhouseCoopers</p>
                        </div>
                ...
                <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300 bg-slate-200'>
                    <div className='gap-4 justify-center items-center'>
                        <div className='m-auto'>
                            ...
                            height={64} 
                            alt='/'/>
                            <p className='text-black'>Suzhou University of Science and Technology</p>
                        </div>
                        <div className='py-4 text-gray-600 '>
